...
class ScreenDetail extends StatefulWidget {
  const ScreenDetail({Key? key, required this.ocurrency}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              flex: 4,
                              child: Text(
                                  'CPF: ${widget.ocurrency.cliente!.cpf}')),
                          Expanded(
                              flex: 1,
                              child: InkWell(
                                  onTap: () {
                      ...
                      child: Row(
                        children: [
                          Expanded(
                              flex: 4,
                              child: Text(
                                  'CEP: ${widget.ocurrency.cliente!.cep}')),
                          Expanded(
                              flex: 1,
                              child: InkWell(
                                  onTap: () {
